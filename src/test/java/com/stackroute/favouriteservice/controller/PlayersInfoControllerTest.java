...
public class PlayersInfoControllerTest {
	
	@Mock
	private IPlayersInfoService playerServiceTest;

	@InjectMocks
	private PlayersInfoController playerInfoTest;
	...
	public void fetchFavPlayersDetails()  {
		...
		Mockito.when(playerServiceTest.fetchFavPlayersDetails("Admin")).thenReturn(list);
		
		playerInfoTest.fetchFavPlayersDetails("Admin");
	}
	...
	public void saveFavouritePlayers() throws SQLException  {
		...
		Mockito.when(playerServiceTest.saveFavouritePlayers("Admin",masterView)).thenReturn(res);
		
		playerInfoTest.saveFavouritePlayers("Admin",masterView);
	}
	...
	public void removeFavouritePlayers() throws SQLException  {
		...
		Mockito.when(playerServiceTest.removeFavouritePlayers("Admin",masterView)).thenReturn(res);
		
		playerInfoTest.removeFavouritePlayers("Admin",masterView);
